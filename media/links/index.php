<?php 
	...
	require "media/php/bankinfos.php";
...
<head>
    ...
    <title>Welcome To Gambari Micro-Finance Bank</title>
    ...
    <div class="container body">
        ...
        <div class="main_container">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="images/img.jpg" alt=""> Isaac Mayowa <?php # echo users_name; ?>
            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p>
                            <h4> List of Transactions Carried out since May 2015</h4></p>
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">Copyright &copy; 2016, ShoonexIT- in Collision with MayorjoIT Support Team Ltd.                             <span class="lead"> <i class="fa fa-paw"></i> MKonsult</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
